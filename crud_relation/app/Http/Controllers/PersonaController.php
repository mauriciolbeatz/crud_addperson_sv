...
class PersonaController extends Controller
{
    ...
    {
        $persona = new Persona();
        $municipio = Municipio::pluck('name', 'id');
        return view('persona.create', compact('persona', 'municipio'));
    }
    ...
    public function show($id)
    {
        ...
        $municipio = Municipio::pluck('name', 'id');
        return view('persona.show', compact('persona', 'municipio'));
    }
    ...
    public function edit($id)
    {
        $persona = Persona::find($id);
        $municipio = Municipio::pluck('name', 'id');
        return view('persona.edit', compact('persona','municipio'));
    }
